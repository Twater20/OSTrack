...
python tracking/train.py --script timostrack --config vitb_256_mae_ce_96x1_got10k_ep100 --save_dir ./output --mode single --use_wandb 1
python tracking/train.py --script timostrack --config vitb_256_mae_ce_96x1_ep300 --save_dir ./output --mode single --use_wandb 1
python tracking/train.py --script timostrack --config vitb_256_mae_ce_64x2_ep340 --save_dir ./output --mode multiple --nproc_per_node 2 --use_wandb 1
...
`python tracking/test.py timostrack vitb_256_mae_ce_96x1_got10k_ep100 --dataset got10k_test --threads 16 --num_gpus 1`

python lib/test/utils/transform_got10k.py --tracker_name ostrack --cfg_name vitb_384_mae_ce_32x4_got10k_ep100
python lib/test/utils/transform_got10k.py --tracker_name timostrack --cfg_name vitb_256_mae_ce_96x1_got10k_ep100
```
...
python tracking/test.py ostrack vitb_256_mae_ce_32x4_ep300 --dataset trackingnet --threads 16 --num_gpus 1
python tracking/test.py ostrack vitb_256_mae_ce_96x1_ep300 --dataset trackingnet --threads 16 --num_gpus 1
python tracking/test.py timostrack vitb_256_mae_ce_96x1_ep300 --dataset trackingnet --threads 16 --num_gpus 1
python lib/test/utils/transform_trackingnet.py --tracker_name ostrack --cfg_name vitb_384_mae_ce_32x4_ep300
python lib/test/utils/transform_trackingnet.py --tracker_name timostrack --cfg_name vitb_256_mae_ce_96x1_ep300
```
